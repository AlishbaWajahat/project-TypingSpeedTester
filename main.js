...
let Text = {
    ...
    Medium: "The serene beauty of the sunset over the tranquil lake was a sight to behold, casting hues of orange and pink across the sky. It was a perfect end to a day filled with adventure and discovery.",
...
async function TestStarts(text) {
    if (text === "Easy") {
        console.log(`Here is you sample text..`);
        console.log(`"${Text[text]}"`);
        console.log(chalk.cyanBright(`Intruction: Start typing once your test starts , type as fast as you can before timer ends..`));
        await wait().then(() => {
        ...
        console.log(`Here is you sample text..`);
        console.log(`"${Text[text]}"`);
        console.log(chalk.cyanBright(`Intruction: Start typing once your test starts , type as fast as you can before timer ends & once you are done press ENTER to see your result..`));
        await wait().then(() => {
            console.log(`Start typing!`);
        });
    }
    ...
    while (true) {
        ...
        if (question1.Options === "Create an account-SignUp") {
            ...
            if (userExists(question2.name, question2.email, question2.password)) {
                ...
                let newUser = new user(question2.name, question2.email, question2.password);
                users.push(newUser);
                console.log(chalk.greenBright(`Your account has been created successfully!`));
            }
        }
                ...
                while (condition1) {
                    ...
                    if (questiona.choice === "Start test") {
                        ...
                        while (condition) {
                            ...
                            let USER = users.findIndex((user) => user.name === questionb.userName);
                        ...
                        let USER = users.findIndex((user) => user.name === questione.userName);
                        let RealUser = users[USER];
                        if (!RealUser) {
